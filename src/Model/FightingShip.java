...
public class FightingShip extends Ship{
    private int size = 5;
    ...
    public String shoot() {
        ...
        if(hits>=size){
            setSunk(true);
            return String.format("Du sänkte en %s", ShipType.fightingShip.name());
        }else if(hits<size){
            return String.format("Du träffade en %s", ShipType.fightingShip.name());
        }
